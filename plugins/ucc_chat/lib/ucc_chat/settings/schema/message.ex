defmodule UccChat.Settings.Schema.Message do
  use UccSettings.Settings.Schema

  @primary_key {:id, :binary_id, autogenerate: true}
  @foreign_key_type :binary_id

  schema "settings_messages" do
    ...
    field :embeded_ignore_hosts, :string, default:
  ...
  @fields [
    :allow_message_editing, :block_message_editing_after,
    :block_message_deleting_after, :allow_message_deleting,
    :show_edited_status, :show_deleted_status, :allow_bad_words_filtering,
    :add_bad_words_to_blacklist, :max_channel_size_for_all_message,
    :max_allowed_message_size, :show_formatting_tips, :grouping_period_seconds,
    :embed_link_previews, :disable_embedded_for_users,
    :embeded_ignore_hosts, :time_format, :date_format, :hide_user_join,
    :hide_user_leave, :hide_user_removed, :hide_user_added, :hide_user_muted,
    :allow_message_pinning, :allow_message_staring, :allow_message_snippeting,
    :autolinker_strip_prefix, :autolinker_scheme_urls, :autolinker_www_urls,
    :autolinker_tld_urls, :autolinker_url_regexl, :autolinker_email,
    :autolinker_phone,
  ]
