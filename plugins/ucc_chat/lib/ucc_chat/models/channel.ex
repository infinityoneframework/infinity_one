defmodule UccChat.Channel do
  ...
  schema "channels" do
    ...
    has_many :stared_messages, UccChat.StaredMessage, on_delete: :delete_all
    has_many :messages, UccChat.Message, on_delete: :delete_all
    has_many :notifications, UccChat.Notification, on_delete: :delete_all
