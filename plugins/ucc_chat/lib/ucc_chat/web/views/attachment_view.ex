defmodule UccChat.Web.AttachmentView do
  ...
  def get_attachment(attachment) do
    ...
    |> Enum.into(%{
      ...
      file_name: UccChat.File.filename(:original, attachment),
      url: UccChat.File.url({attachment.file, attachment}) |> view_url,
  ...
  defp media_types("image/" <> type, attachment) do
    poster_url = UccChat.File.url({attachment.file, attachment}, :poster) |> view_url
