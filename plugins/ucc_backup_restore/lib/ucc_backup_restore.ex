defmodule UccBackupRestore do
  @moduledoc """
  Backup and Restore the UcxUcc Application Data.

  Create Backups of UcxUcc data for general data recovery, server migrations,
  ...
  * uploads.tgz
  ...
  defp create_tempdir(config) do
    case Briefly.create(directory: true) do
      {:ok, path} ->
        File.write!(Path.join(path, "VERSION"), UcxUcc.version())
