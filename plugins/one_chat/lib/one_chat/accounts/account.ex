defmodule OneChat.Accounts.Account do
  use Unbrella.Plugin.Schema, InfinityOne.Accounts.Account

  import Ecto.Query

  alias InfinityOne.Accounts.{User, Account}
  alias OneChat.Schema.{Notification, AccountNotification}
  alias InfinityOne.OnePubSub

  require Logger

  extend_schema InfinityOne.Accounts.Account do
  ...
  def notify_changes(changeset, field, value) when not is_nil(value) do
    OnePubSub.broadcast "user:all", "account:change", %{
