defmodule OneChat.MessageCogService do
  # import Ecto.Query

  alias OneChat.{Message, StarredMessage, PinnedMessage}
  alias OneChatWeb.{MessageView, FlexBarView}

  alias InfinityOne.Repo
  alias OneChat.ServiceHelpers, as: Helpers
  # alias OneChat.Schema.StarredMessage, as: StarredMessageSchema
  ...
  def handle_in("delete-message", msg, socket) do
    ...
    OneChatWeb.MessageChannelController.delete socket, msg
  end
