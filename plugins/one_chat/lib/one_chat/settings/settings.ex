defmodule OneChat.Settings do
  @moduledoc """
  The overall application settings the OneChat Plug In.

  With the use of `OneSettiongs`, this module provides accessors and
  ...
  def desktop_notification?(user, channel_id, mention) do
    chat_general = OneChat.Settings.ChatGeneral.get
    ...
    opts = %{
      mention: mention,
      desktop: desktop,
      system_enable: OneSettings.enable_desktop_notifications,
  ...
  * The user's notification settings from the Notifications FlexTab.
  ...
  def get_system_new_message_sound,
    do: OneChat.Settings.default_message_notification_audio()
