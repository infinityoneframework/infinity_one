defmodule OneChatWeb.FlexBar.Tab.Info do
  use OneChatWeb.FlexBar.Helpers
  use OneLogger

  alias OneChat.Channel
  alias InfinityOne.{OnePubSub, Accounts, TabBar.Tab, Permissions}
  ...
  defp broadcast(socket, event, payload) do
    OnePubSub.broadcast "user:" <> socket.assigns.user_id, event, payload
    socket
  end
end
