defmodule OneChatWeb.FlexBar.Tab.Notification do
  use OneChatWeb.FlexBar.Helpers

  alias OneChat.Notification
  alias OneChat.AccountService
  ...
  def play(socket, _sender) do
    sound =
      ...
      |> OneChat.Settings.get_new_message_sound(socket.assigns.channel_id)
