defmodule OneChatWeb.AttachmentView do
  use OneChatWeb, :view
  ...
  def get_attachment(attachment) do
    ...
    |> Enum.into(%{
      ...
      file_name: OneChat.File.filename(:original, attachment),
      url: OneChat.File.url({attachment.file, attachment}) |> view_url,
  ...
  defp media_types("image/" <> type, attachment) do
    poster_url = OneChat.File.url({attachment.file, attachment}, :poster) |> view_url
