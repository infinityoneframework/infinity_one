defmodule OneChatWeb.RoomChannel.MessageInput.SpecialKeys do
  @moduledoc """
  ...
  def handle_in(%{app: _} = context, @dn_arrow) do
    ...
    Client.async_js context.socket, "OneUtils.downArrow()"
  end

  def handle_in(%{app: _, open?: true} = context, @up_arrow) do
    # Logger.info "up arrow"
    Client.async_js context.socket, "OneUtils.upArrow()"
  end
