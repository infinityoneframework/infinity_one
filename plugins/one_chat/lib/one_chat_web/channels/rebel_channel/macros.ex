defmodule OneChatWeb.RebelChannel.Macros do
  ...
  defmacro __using__(_) do
    quote do
      ...
      import OneChatWeb.RebelChannel.Client, warn: false
    end
  end
  ...
  defmacro defdelegateadmin(name) do
    quote bind_quoted: [name: name] do
      defdelegate unquote(name)(socket, sender), to: OneAdminWeb.AdminChannel
    end
  end
