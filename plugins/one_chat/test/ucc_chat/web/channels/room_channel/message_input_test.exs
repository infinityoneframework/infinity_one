defmodule OneChatWeb.RoomChannel.MessageInputTest do
  ...
  #     {:ok, socket} = connect(InfinityOneWeb.UserSocket, %{})
  #     {:oke, _, socket} =
  #       ""
  #       |> socket(%{
  #         self: self(),
  ...
  #       })
  #       |> subscribe_and_join(OneChatWeb.RoomChannnel, CC.chan_room <> channel.name)
