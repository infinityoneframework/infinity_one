defmodule OneChat.TestHelpers do
  alias FakerElixir, as: Faker
  # alias InfinityOne.{Repo, Accounts}
  # alias Accounts.{User, Role, UserRole}
  alias OneChat.{ChannelService, Subscription}
  alias InfinityOne.{Repo}
  alias InfinityOne.TestHelpers
  alias OneChat.{Notification, AccountNotification}

  Code.ensure_compiled InfinityOne.TestHelpers
  ...
  def insert_account(user, attrs \\ %{}) do
    user
    |> InfinityOne.TestHelpers.insert_account(attrs)
