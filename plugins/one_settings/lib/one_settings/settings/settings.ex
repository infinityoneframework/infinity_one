defmodule OneSettings.Settings do
  ...
  this module to add the required behaviour.
      ...
      defmodule OneSettings.Settings.Config.General do
        use OneSettings.Settings, scope: inspect(__MODULE__), repo: OneSettings.Repo, shcema: [
            [name: "site_title", type: "string", default: "InfinityOne"],
  ...
  defmacro __using__(opts \\ []) do
    quote bind_quoted: [opts: opts] do
      ...
      def key do
        OneSettings.Utils.module_key __MODULE__
      end
