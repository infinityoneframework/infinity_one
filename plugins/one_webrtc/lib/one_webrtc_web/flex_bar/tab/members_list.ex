defmodule OneWebrtcWeb.FlexBar.Tab.MembersList do
  use OneLogger
  ...
  alias OneChatWeb.FlexBar.Tab.MembersList, as: ChatMembersList
  ...
  def video_args(socket, current_user_id, _channel_id, user_id) do
    ...
    Logger.info "video args curr_id: #{current_user_id}, user_id: #{user_id}"
