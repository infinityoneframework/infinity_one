defmodule InfinityOneWeb.UserSocket do
  use Phoenix.Socket
  ...
  ## Channels
  channel CC.chan_room <> "*", OneChatWeb.RoomChannel    # "ucxchat:"
  channel CC.chan_user <> "*", OneChatWeb.UserChannel  # "user:"
  channel CC.chan_system <> "*", OneChatWeb.SystemChannel  # "system:"
  ...
  #
  #     InfinityOneWeb.Endpoint.broadcast("user_socket:#{user.id}", "disconnect", %{})
  #
